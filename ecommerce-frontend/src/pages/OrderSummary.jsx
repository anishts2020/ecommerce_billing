...
export default function OrderSummary() {
  ...
  // const [paymentMode, setPaymentMode] = useState(""); // no default
    ...
    if (isSingle) {
      ...
      if (item) {
        ...
        setOrderTotals({
          total_amount: total,
          gst_amount: gst,
          grand_total: +(total + gst).toFixed(2),
        });
      }
      return;
    }
  ...
  const goToPayment = () => {
    if (!billingAddress || !shippingAddress) {
      alert("Please enter billing & shipping address");
      return;
    }
    ...
    const isSingle = sessionStorage.getItem("is_single_buy") === "true";
    const cartIdForOrder =
      sessionStorage.getItem("cart_id_for_order") || null;
    ...
    <Layout>
      <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-6 mt-6">
        ...
        <div className="mt-6 p-4 border rounded bg-gray-50">
          <p>
            <b>Total Amount:</b> ₹{orderTotals.total_amount}
          </p>
        ...
        {/* <div className="mt-6">
          ...
          >
            ...
            <option value="flipkart_upi">Flipkart UPI</option>
            <option value="upi/gpay">UPI - Google Pay</option>
            <option value="upi/paytm">UPI - Paytm</option>
            <option value="upi/new">New UPI ID</option>
