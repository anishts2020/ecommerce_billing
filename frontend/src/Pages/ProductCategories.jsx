...
//         className={`bg-white p-6 rounded-xl w-96 border-t-8 shadow-xl ${type === "success"
//             ? "border-green-500"
//             : type === "error"
//               ? "border-red-500"
//               : "border-gray-500"
...
//           <button
//             onClick={onConfirm}
//             className={`px-4 py-2 text-white rounded ${type === "success"
...
//                       className={`text-sm px-3 py-1 font-medium text-white rounded-lg shadow-md transition ${p.new_arrivals === 1
